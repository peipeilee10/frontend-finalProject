              ...
              <v-row no-gutters>
                ...
                <v-col cols="8" class="pr-15 pl-5 pt-5">
                  <div class="item-title">
                    ...
                    <p v-if="appointment.serviceitem === '小美容'">
                  ...
                  <div class="pet-type">
                    ...
                    <v-chip-group
                      ...
                      active-class="orange darken-1 white--text"
                    >
                      <v-chip v-if="pet === '狗狗'" label value="小型犬">
                        小型犬
                      </v-chip>
                      <v-chip v-if="pet === '狗狗'" label value="中型犬">
                        中型犬
                      </v-chip>
                      <v-chip v-if="pet === '狗狗'" label value="大型犬">
                        大型犬
                      </v-chip>
                      <v-chip v-if="pet === '貓貓'" label value="長毛貓">
                        長毛貓
                      </v-chip>
                      <v-chip v-if="pet === '貓貓'" label value="短毛貓">
                        短毛貓
                      </v-chip>
                    </v-chip-group>
                  </div>
