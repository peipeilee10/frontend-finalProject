        ...
        <v-stepper-content step="1">
            ...
            >
              <template v-slot:item.image="{ item }">
                <!-- {{ item }} -->
                <img v-if="item.product.image" :src="item.product.image" style="height: 100px;">
              </template>
            ...
            <v-divider></v-divider>
            <h2 class="mb-15 mt-5 text-right">總金額：{{new Intl.NumberFormat('en-IN').format(total)}} 元</h2>
